...
const resumeURL = "https://drive.google.com/file/d/1mtfyW6paaSJG49POKgIeOEK5ASWMvo4U/view?usp=drivesdk";
      ...
      <div className="introduction">
        <div className="intro-text">
          ...
          <p>
            ...
            NodeJs, SpringBoot, React, TypeScript, Java. I am also familar with Bootstrap and
            Github.
          </p>
          <br />
          <p>
            I am also proficient in HTML, CSS, Javascript, Java and love <span style={{ color: "#32CD30" }}>solving problems</span> involving data structures and algorithms.
          </p>
          <br />
          <p>
