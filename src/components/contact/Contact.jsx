...
const Contact = () => {
  ...
  //   {
  //     site : "Linkedin",
  //     link : "https://www.linkedin.com/in/lawakesh-mule-5314351a0/",
  //   },
  //   {
  //     site : "Github",
  //     link : "https://github.com/lokeshmule3639",
  //   },
  //   {
  //     site : "Twitter",
  //     link : "https://twitter.com/lokesh_3639",
  //   },
  // ]
            ...
            <nav aria-label="main mailbox folders">
              <List>
                <ListItem disablePadding  className="contact-list-item">
                  <ListItemButton  href="https://www.linkedin.com/in/lawakesh-mule-5314351a0/" target="_blank">
                    <ListItemIcon>
                ...
                <ListItem disablePadding className="contact-list-item">
                  <ListItemButton href="https://github.com/lokeshmule3639" target="_blank">
                    <ListItemIcon>
                ...
                <ListItem disablePadding className="contact-list-item">
                  <ListItemButton href="https://twitter.com/lokesh_3639" target="_blank">
                    <ListItemIcon>
                ...
                <ListItem disablePadding className="contact-list-item">
                  <ListItemButton
                    onClick={() =>
                      (window.location = "mailto:lokeshmule3639@gmail.com")
                    }
                  >
                    <ListItemIcon>
                    ...
                    <ListItemText
                      primary="Mail (lokeshmule3639@gmail.com)"
